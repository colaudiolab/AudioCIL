    ...
    def _train(self, train_loader, test_loader):
        ...
        if self._cur_task == 0:
            ...
            if not pretrained:
                ...
                sd = torch.load("/home/ubuntu/shared-data/project/PyCIL/pretrained/ewc_best_base_session_model.pth", map_location=torch.device("cuda" if torch.cuda.is_available() else "cpu"))
