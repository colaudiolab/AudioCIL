    ...
    def _train(self, train_loader, test_loader, val_loader=None):
        ...
        if self._cur_task == 0:
            ...
            if not pretrained:
                ...
                sd = torch.load("/home/ubuntu/shared-data/project/PyCIL/pretrained/beef_last_base_session_model.pth", map_location=torch.device("cuda" if torch.cuda.is_available() else "cpu"))
        ...
        for _, epoch in enumerate(prog_bar):
            ...
            if epoch % 5 == 0:
                ...
                if test_acc > best_acc:
                    best_acc = test_acc
                    torch.save(self._network.state_dict(), "/home/ubuntu/shared-data/project/PyCIL/pretrained/beef_best_base_session_model.pth")
            ...
            torch.save(self._network.state_dict(), "/home/ubuntu/shared-data/project/PyCIL/pretrained/beef_last_base_session_model.pth")
